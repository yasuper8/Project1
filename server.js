...
app.use(function(req, res, next) {
  ...
  res.setHeader("Access-Control-Allow-Headers", "Access-Control-Allow-Headers, Origin,Accept, X-Requested-With"); //Access-Control-Request-Headers  Access-Control-Request-Method  Content-Type
  next();
});
